...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.project-card, .experience-card, .skill-category, .timeline-item, .stat');
...
function sendMessage() {
    ...
    const mailtoLink = `mailto:amrutabmaskar@gmail.com?subject=${subject}&body=${body}`;
